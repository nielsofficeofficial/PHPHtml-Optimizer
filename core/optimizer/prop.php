 ...
 */
  ...
  define('__SELF_REQUEST__', isset( explode('/',$_SERVER['PHP_SELF']) ) || empty( explode('/',$_SERVER['PHP_SELF']) )); // Get SELF_REQUEST
  ...
  define('__INC__', '' ); // Set PARAM SWICTH TO OPTIONAL INCLUDES
