...
| Extra Methods    | PARAMETERS / Description  |
| ---            | ---         |
| `SetFileExtension($PARAM)`       | $extension = Html::SetExtension($argu) - use this to assign extension or format to the file such / <br /> `__PHP__`,  `__HTML__`, `__CSS__`,  `__JS__`,   `__JPG__`, `__JPEG__`, `__PNG__`,  `__GIF__`,  `__BMP__`, `__TEX__`, `__XLS__`,  `__XLSX__`, `__DOCX__`, `__DOCX__`, `__PPT__`, `__PPTX__`, `__ODT__`,  `__TXT__`,  `__RTF__` |
