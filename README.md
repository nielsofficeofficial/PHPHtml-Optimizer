...
html::_ELEMENT('my_input','track');
html::_ELEMENT('my_input','circle');
html::_ELEMENT('my_input','param');
html::_ELEMENT('my_input','meta');
html::_ELEMENT('my_input','link');
html::_ELEMENT('my_input','img');
html::_ELEMENT('my_input','embed');
html::_ELEMENT('my_input','option');
html::_ELEMENT('my_input','col');
html::_ELEMENT('my_input','base');
html::_ELEMENT('my_input','aside');
html::_ELEMENT('my_input','area');
html::_ELEMENT('my_input','DOCTYPE');
